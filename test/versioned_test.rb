...
class VersionedTest < Test::Unit::TestCase
  ...
  def test_associations
    ...
    author.pages.each do |page|
      saved_page_versions << page.versions.last
      page.title = page.title + ' UPDATED!'
      page.save!
    end
    assert_equal saved_page_versions, author.page_versions.existing_at(before_page_updates)
  end
end